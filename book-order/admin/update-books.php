        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <table class = "tbl-30">
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" name="nop" value="<?php echo $nop; ?>">
                    </td>
                </tr>
                <tr>
                    <td>Publish date: </td>
                    <td>
                        <input type="date" name="pub_date" value="<?php echo $pub_date; ?>">
                    </td>
                </tr>
                <tr>
                    <td>Category: </td>
                ...
                <tr>
                    <td>
                        ...
                        <input type="submit" name="submit" value="Update Book" class = "btn-update">
                    </td>
                </tr>
            </table>
        </form>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $dst_path = "../images/book/".$image_name;
                        $upload = move_uploaded_file($src_path,$dst_path);
                        if($upload==false)
                        {
                            $_SESSION['upload2'] = "Failed to upload image";
                            header("location:".SITEURL.'admin/manage-books.php');
                            die();
                        }
                        if($current_image != "")
                ...
                if($res3==TRUE)
                {
                    ...
                    header("location:".SITEURL.'admin/update-books.php');
                }
            }
        ?>
    </div>
